          ...
          {projects.map((p) => (
            ...
            >
              <motion.div
                ...
                className="aspect-[4/3] relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-500"
              >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {projects.map((p) => (
            ...
            >
              ...
              >
                <ProjectCover project={p} className="absolute inset-0" />
                <div className="relative flex h-full flex-col justify-between text-white p-6">
                  <span className="text-xs uppercase tracking-widest opacity-80">{p.category}</span>
